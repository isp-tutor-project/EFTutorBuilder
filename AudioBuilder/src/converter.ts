import { segmentVal } from "./IAudioTypes";
...
export function convert(outFileName:string, waveFile:Uint8Array, seg:segmentVal) {
...
function trim(audioSource:Int16Array, minSilenceHead:number, minSilenceTail:number, dbSilence:number, seg:segmentVal) {
    ...
    else trimEnd = audioSource.length - 1;
